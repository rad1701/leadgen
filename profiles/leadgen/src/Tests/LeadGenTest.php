...
/**
 * @file
 * Contains \Drupal\leadgen\Tests\LeadGenTest.
 */

namespace Drupal\leadgen\Tests;
...
/**
 * Tests LeadGen installation profile expectations.
 *
 * @group leadgen
 */
class LeadGenTest extends WebTestBase {

  use SchemaCheckTestTrait;

  protected $profile = 'leadgen';
  ...
  /**
   * Tests LeadGen installation profile.
   */
  function testLeadGen() {
    $this->drupalGet('');
    ...
    // leadgen profile modules are enabled.
    ...
    // Ensure that configuration from the LeadGen profile is not reused when
